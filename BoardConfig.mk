DEVICE_TREE := device/samsung/heroltekor
...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_herolte
TARGET_KERNEL_VARIANT_DEFCONFIG := variant_herolte_kor
...
TARGET_INIT_VENDOR_LIB := libinit_heroltekor
TARGET_RECOVERY_DEVICE_MODULES := libinit_heroltekor
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_heroltekor.cpp
