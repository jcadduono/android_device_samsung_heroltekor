...
TARGET_PREBUILT_KERNEL := device/samsung/heroltekor/Image
TARGET_PREBUILT_DTB := device/samsung/heroltekor/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/heroltekor/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/heroltekor/init/init_heroltekor.cpp
